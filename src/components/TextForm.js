  ...
  return (
    <>
      ...
      <div
        ...
        style={{ color: props.mode === "light" ? "black" : "white" }}
      >
        <h5 className="text-decoration-underline">Your Text Summary</h5>
        <p className="text-secondary">
          {text.split(" ").length} words, {text.length} characters
        </p>
        <p className="text-secondary">{0.008 * text.split(" ").length} Minutes required to read.</p>
        <h5 className="text-decoration-underline">Preview:</h5>
        <p className="text-secondary">
